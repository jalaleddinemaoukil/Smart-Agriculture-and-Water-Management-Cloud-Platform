...
export default function Settings() {
  ...
  type LevelKey<M extends MetricKey> = keyof Thresholds[M];

  const handleThresholdChange = <M extends MetricKey, L extends LevelKey<M>>(metric: M, level: L, value: string) => {
    setThresholds(prev => ({
      ...prev,
      [metric]: { ...prev[metric], [level]: parseFloat(value) as any }
    }));
  };
